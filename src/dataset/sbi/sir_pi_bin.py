...
class SIR(object):
    ...
    def get_data(
        ...
        for i in range(batch_size):
            ...
            gamma = theta_2_sampler.sample_theta_from_bin_distribution(bin_weights_gamma)

            sampled_points.append(self.simulate_sir(beta,
                                                    gamma,
                                                    bin_weights_beta,
                                                    bin_weights_gamma,
                                                    10))  # we use fixed num_points
    ...
    def simulate_sir(self,
        ...
        yd = I_sampled.unsqueeze(-1)[d_index] / 1000  # [num_points, 1], normalize by the total count
