...
class TurinOnlineAll(object):
    def __init__(self, B=5e8, tau0=0, Ns=101, order="random"):
        ...
        self.G0_std_narrow = torch.tensor(1e-9)  # 10% of the range
        self.G0_std_wide = torch.tensor(2.5e-9)  # 25% of the range
        self.T_std_narrow = torch.tensor(1e-9)
        self.T_std_wide = torch.tensor(2.5e-9)
        self.Lambda_0_std_narrow = torch.tensor(5e8)
        self.Lambda_0_std_wide = torch.tensor(1.25e9)
        self.sigma2_N_std_narrow = torch.tensor(1e-10)
        self.sigma2_N_std_wide = torch.tensor(2.5e-10)
